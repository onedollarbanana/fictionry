...
export const metadata = {
  ...
  description: "Stories with the latest chapter drops",
};
...
export default async function RecentlyUpdatedPage({ searchParams }: PageProps) {
  ...
  if (error) console.error("Recently updated query error:", error);
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">
          Stories with the latest chapter drops
        </p>
      </div>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground">
              No recently updated stories found{genre ? ` in ${genre}` : ""}.
            </p>
          </CardContent>
        </Card>
      ) : (
